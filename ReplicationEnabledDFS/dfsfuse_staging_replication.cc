...
class NfsServiceImpl_staging final : public NFS_Stagingserver::Service {
	...
	Status nfsfuse_readdir(ServerContext* context, const String* s) {
		...
		(void) context;
		cout<<"[DEBUG:] dfsfuse_readdir function called in staging server"<<endl;
	...
	*/	
	...
	(void) context;
        cout<<"[DEBUG:] dfsfuse_open function callled at staging server"<<endl;
    ...
    Status nfsfuse_read(ServerContext* context, const ReadRequest* rr, 
        ...
        (void) context;
	cout<<"[DEBUG:]  dfsfuse_read function called at staging server "<<endl;
	...
	(void) context;
	cout<<"[DEBUG:] dfsfuse_write function called at staging server"<<endl; 
    ...
    Status nfsfuse_create(ServerContext* context, const CreateRequest* req,
	    ...
	    (void) context;	
	    cout<<"[DEBUG:] dfsfuse_create called at staging server"<<endl;
    ...
    Status nfsfuse_mkdir(ServerContext* context, const MkdirRequest* input,
	    ...
	    (void) context;
	    cout<<"[DEBUG:] dfsfuse_mkdir function called at staging server"<<endl;
    ...
    Status nfsfuse_rmdir(ServerContext* context, const String* input,
	    ...
	    (void) context;
	    cout<<"[DEBUG:]  dfsfuse_rmdir function callled at staging server"<<endl;
    ...
    Status nfsfuse_unlink(ServerContext* context, const String* input,
            ...
            (void) context;	    
	    cout<<"[DEBUG:]  dfsfuse_unlink function called at staging server"<<endl;
	...
	(void) context;    
        cout<<"[DEBUG:]  dfsfuse_rename function called at staging server"<<endl;
	...
	(void) context;
	cout<<"[DEBUG:]  dfsfuse_utimens function called at staging server"<<endl;
    ...
    Status nfsfuse_mknod(ServerContext* context, const MknodRequest* input,
       ...
       // cout<<"[DEBUG] : mknod " << endl;
        (void) context;
	cout<<"[DEBUG:]  dfsfuse_mknod function called at staging server"<<endl;
